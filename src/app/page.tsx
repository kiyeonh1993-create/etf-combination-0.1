      ...
      <div className="max-w-3xl mx-auto space-y-10">
        ...
        <header className="text-center space-y-4 py-4">
          <div className="flex justify-center gap-2">
            <span className="bg-[#3182F6] text-white text-[10px] px-3 py-1 rounded-full font-black shadow-sm uppercase tracking-widest">v0.2.4 Optimization</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-black tracking-tight text-[#191F28]">QQQ x SCHD 황금비율 시뮬레이터</h1>
          <p className="text-[#8B95A1] text-sm md:text-base font-medium">과거 12년 데이터를 기반으로 나만의 최적 조합을 찾아보세요.</p>
        </header>
        ...
        <section className="bg-white p-8 md:p-10 rounded-[40px] shadow-sm border border-[#F2F4F6] space-y-8">
          <h3 className="text-xl font-black tracking-tight">수익률 비교분석 (2014-2025)</h3>
          <div className="h-[360px] w-full">
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart data={results.chartData} margin={{ top: 10, right: 10, left: 40, bottom: 0 }}>
                <defs>
                ...
                />
                <Legend verticalAlign="top" align="right" iconType="circle" iconSize={8} wrapperStyle={{ fontSize: '10px', fontWeight: 'bold', color: '#8B95A1', paddingBottom: '20px' }} />
        ...
        <footer className="text-center py-10 space-y-6">
          ...
          <p className="text-[11px] text-[#B0B8C1] leading-relaxed px-6">
            ...
            이 시뮬레이션은 과거 데이터를 기반으로 한 참고용 수치입니다. 실제 결과는 다를 수 있습니다.
          </p>
        </footer>
      </div>
